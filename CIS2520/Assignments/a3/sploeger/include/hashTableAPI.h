...
struct HTable
{
	...
	int (*hashFunction)(char* key); ///< function pointer to a function to hash the data 
...
**/
HTable *createTable(size_t size, int (*hashFunction)(char* word),void (*destroyData)(void *data),void (*printNode)(void *toBePrinted));
